                    ...
                    children: [
                     SizedBox(
                       ...
                       child: Stack(
                         children: [
                           CarouselSlider(
                               items: List.generate(movieImages.length, (index) => Container(
                           ...
                           Positioned(
                             ...
                             child: Container(
                               ...
                               decoration: BoxDecoration(
                                 ...
                                 image: DecorationImage(
                                     fit: BoxFit.fill,
                                     image: NetworkImage('${map['tvShow']['image_path']}'))
                               ),
                             ),
                           ),
                           ...
                           Positioned(
                             top: 170,
                             left: 150,
                             child: Text('${map['tvShow']['name']}',style: TextStyle(
                           ...
                           Positioned(
                             top: 190,
                             left: 150,
                             child: Text('${map['tvShow']['start_date']}',style: TextStyle(
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          return Container(
                            ...
                            child:
                              Text(genres[index],style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Text('${map['tvShow']['description']}',style: TextStyle(
                              fontWeight: FontWeight.w600,
                              fontSize: 14
                          ),),
                        ),
                      ...
                      Center(
                        child: Text('Web URL',style: TextStyle(
                            fontWeight: FontWeight.w800,
                            fontSize: 18
                        ),),
                      ),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text('${map['tvShow']['url']}',style: TextStyle(
                                fontWeight: FontWeight.w600,
                                fontSize: 14
                            ),
